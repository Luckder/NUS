...
public class OptimizationTest {
    ...
    public void testOptimization1() {
        int[] dataArray = {1, 3, 5, 7, 9, 11, 10, 8, 6, 4}; // increase then decrease
        assertEquals(11, Optimization.searchMax(dataArray));
    }

    @Test
    public void testOptimization2() {
        int[] dataArray = {67, 65, 43, 42, 23, 17, 9, 100}; // decrease then increase
    ...
    public void testOptimization5() {
        int[] dataArray = {1};
        assertEquals(1, Optimization.searchMax(dataArray));
    }
